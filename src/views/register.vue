            ...
            <div class="h-[calc(100vh-277px)] flex justify-center items-center">
              <div class="w-full px-36">
                ...
                <form class="space-y-5 dark:text-white" @submit.prevent="submit">
                  ...
                  <div>
                    <label class="dark:text-white-dark">Phone</label>
                  ...
                  <div>
                    <label class="dark:text-white-dark">Referal Code</label>
                    ...
                    <div v-if="v$.referal.$error"
                      class="validator">
                      {{ v$.referal.$errors[0].$message }}
                    </div>
                  </div>

                  <!-- <BtnPublic :loadings="loading" margins="!my-8" texts="Register"/> -->
                  <router-link
                    to="/verify-email/alksjhd208308ksndkjssak090">
                    <BtnPublic :loadings="loading" :types="false" margins="!my-8" texts="Register"/>
                  </router-link>
