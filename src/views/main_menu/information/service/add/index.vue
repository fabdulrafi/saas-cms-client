<template>
  <div>
    <div class="flex items-center whitespace-nowrap">
      <router-link
        to="/main-menu/information/service"
      ...
      <h5
        ...
        <div class="text-sm text-gray-400 font-semibold">
          Information / Service / <span class="capitalize text-black dark:text-white-light">{{ router.currentRoute.value.meta.title }}</span>
        </div>
      </h5>
    ...
    <div class="panel p- mt-[24px] shadow-none rounded-xl">
      <div class="flex-1 grid grid-cols-1 gap-6">
        <div>
          ...
          <div class="text-sm text-gray-400 font-semibold">
            Add and customize a new service according to your preferences
          </div>
        </div>
    ...
    <div class="panel p- my-6 shadow-none rounded-xl">
      <div class="flex-1 grid grid-cols-1 gap-6">
        <div>
          ...
          <div class="text-sm text-gray-400 font-semibold">
            Media information of your service
          </div>
        </div>
...
<script lang="ts" setup>
  ...
  const { loading, data, post, errorMessage, error } = useApiWithAuth('client/information');
  ...
  const submit = async () => {
    ...
    post(payload).then(() => {
      ...
      router.push('/main-menu/information/service');
    });
  };
</script>
