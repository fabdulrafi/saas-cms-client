<template>
  <div>
    <div class="flex items-center whitespace-nowrap">
      <router-link
        to="/main-menu/promotion/screen-saver"
      ...
      <div class="">
        <div class="flex-1 grid grid-cols-1 sm:grid-cols-5 gap-6 xs:gap-2">
          ...
          <div class="col-span-4 xs:mb-4">
            <div class="flex-1 grid grid-cols-1 sm:grid-cols-8 gap-6 xs:gap-2">
              <div class="flex items-center">
                ...
                <div
                  @click="payload.schedule = !payload.schedule"

                  class="text-sm cursor-pointer ml-3">
                  {{ payload.schedule ? 'Yes' : 'No' }}
                </div>
              </div>

              <div v-if="payload.schedule"
                class="col-span-7">
                <div class="flex-1 grid grid-cols-1 sm:grid-cols-8 gap-6 xs:gap-2">
          ...
          <div class="col-span-4">
            ...
            <div v-if="v$.attachment_json_array.$error"
              class="validator">
              {{ v$.attachment_json_array.$errors[0].$message }}
            </div>
          </div>
        </div>
      </div>
