    ...
    <div 
      ...
      <div
        ...
        <div class="!mt-[20px]">
          <perfect-scrollbar
            ...
            class="chat-users relative h-full min-h-[100px] sm:h-[calc(100vh_-_382px)] space-y-0.5 ltr:pr-3.5 rtl:pl-3.5 ltr:-mr-3.5 rtl:-ml-3.5">
            <template v-for="person in searchUsers" :key="person.id">
              <button
                ...
                <div class="font-semibold whitespace-nowrap text-xs mb-5">
                  <p>{{ person.time }}</p>
                </div>
              </button>
            </template>
      ...
      <div class="panel shadow-none rounded-xl p-0 flex-1">
        <template v-if="!isShowUserChat">
          <div class="flex items-center justify-center h-full relative p-4">
            ...
            <div class="py-8 flex items-center justify-center flex-col">
              <div class="w-[280px] md:w-[430px] mb-8 h-[calc(100vh_-_400px)] xs:h-[calc(100vh_-_380px)] min-h-[120px] text-white dark:text-[#0e1726]">
                <svg
                  ...
                  <circle cx="36.81601" cy="125.19345" r="13.13371" fill="#2A4896" />
                  ...
                  <circle cx="563.81601" cy="445.19345" r="13.13371" fill="#2A4896" />
        ...
        <template v-if="isShowUserChat && selectedUser">
          <div class="relative h-full xs:h-[630px]">
            <div class="flex justify-between items-center p-4">
              <div class="flex items-center xs:space-x-3 rtl:space-x-reverse">
            ...
            <perfect-scrollbar class="relative h-full sm:h-[calc(100vh_-_375px)] xs:h-[calc(100vh_-_355px)] chat-conversation-box">
