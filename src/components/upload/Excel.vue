    ...
    setup(props, { emit }) {
      ...
      const onFileChanged = ($event: Event) => {
        ...
        if (target && target.files) {
          ...
          if (file.value.type !== 'application/vnd.ms-excel' && file.value.type !== 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
            swalAlert('Tipe file .xls/.xlsx', 'error');
          }
