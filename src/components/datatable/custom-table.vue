<template>
  <div class="bh-datatable bh-antialiased bh-relative bh-text-black bh-text-sm bh-font-normal">
        ...
        <tbody>
          <template v-if="filterRowCount">
            <tr
              ...
              :key="
                // @ts-ignore
                item[uniqueKey] ? item[uniqueKey] : i"
            ...
            >
              ...
              >
                <div class="bh-checkbox">
                  <input v-model="selected" type="checkbox"
                    :value="
                      // @ts-ignore
                      item[uniqueKey] ? item[uniqueKey] : i" @click.stop />
                  <div>
              ...
              <template v-for="(col, j) in props.columns">
                <td
                  ...
                  :class="[
                    typeof props.cellClass === 'function' ?
                      // @ts-ignore
                      cellClass(item) : props.cellClass,
                ...
                >
                  ...
                  <div v-else-if="col.cellRenderer" v-html="
                    // @ts-ignore
    ...
    <div v-if="props.pagination && filterRowCount" class="bh-pagination bh-py-5 px-4" :class="{ 'bh-pointer-events-none': currentLoader }">
