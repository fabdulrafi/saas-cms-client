<template>
  <div>
    ...
    <nav
      ...
      <a
        href="javascript:;"
        class="bg-primary ltr:rounded-tl-full rtl:rounded-tr-full ltr:rounded-bl-full rtl:rounded-br-full absolute ltr:-left-12 rtl:-right-12 bottom-3 my-auto w-12 h-10 flex justify-center items-center text-white cursor-pointer"
      ...
      <perfect-scrollbar
        ...
        <div>
          <div class="text-center relative pb-5">
            ...
            <h4 class="mb-1 dark:text-white">
              SMARTIV TEMPLATE
            </h4>

            <p class="text-white-dark">
              Set preferences to determine your website template.
            </p>
          </div>
