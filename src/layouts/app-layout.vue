<template>
  ...
  <div class="relative">
    ...
    <div
      ...
      <svg width="64" height="64" viewBox="0 0 135 135" xmlns="http://www.w3.org/2000/svg" fill="#2A4896">
          <path
    ...
    <div class="fixed bottom-2 ltr:right-6 rtl:left-6 z-50">
